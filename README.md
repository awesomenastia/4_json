...
The program accepts one-line JSON and turns it into beautiful and easy-to-read one.

# Quickstart

For getting started you should clone this repository to your local machine and launch `pprint_json.py`
...
Enter filepath: /home/nastassia/PycharmProjects/json_formatting/4_json/data.json
#console output
[
    {
        "Cells": {
